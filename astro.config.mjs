      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: "Local Files", slug: "music-providers/local-files" },
            ...
            { label: "ORF Radiothek", slug: "music-providers/orf-radiothek" },
        ...
        },
        {
          ...
          items: [
            ...
            { label: "Home Assistant", slug: "player-support/home-assistant" },
            { label: "Local Audio Out", slug: "player-support/local-audio" },
            { label: "MSX Bridge", slug: "player-support/msx-bridge" },
            { label: "Music Player Daemon (MPD)", slug: "player-support/music-player-daemon" },

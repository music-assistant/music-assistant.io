...
Look in the logs and try and resolve any errors you see there particularly those related to [tagging](/music-providers/filesystem/#tagging-files). Connection errors are symptomatic of networking problems (including Adguard or pi-hole blocking) or container misconfiguration.
...
Ensure local files are [tagged properly](/music-providers/filesystem/#tagging-files).

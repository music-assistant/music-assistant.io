...
The tone controls apply a basic three frequency [Parametric Equaliser](parametriceq) filter to the audio signal utilising the Peak (aka Bell) filter type. The following image shows the resultant effect of setting all three controls to +4.0dB

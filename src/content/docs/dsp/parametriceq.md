...
- **Filter Type:** This determines the <a href="https://www.musicguymixing.com/eq-filters/" target="_blank" rel="noopener noreferrer">shape of the adjustment</a>. The available options are Peak (aka Bell), High Shelf, Low Shelf, High Pass, Low Pass, and Notch.
...
If you have measured your speakers, or want to correct your headphones with <a href="https://autoeq.app/" target="_blank" rel="noopener noreferrer">AutoEQ</a>, you can automatically import a preset into this filter.

Music Assistant accepts <a href="https://equalizerapo.com" target="_blank" rel="noopener noreferrer">Equalizer APO's Parametric EQ</a> file format which is widely adopted in various applications, and this import functionality also works seamlessly with <a href="https://www.roomeqwizard.com" target="_blank" rel="noopener noreferrer">Room EQ Wizard</a> (REW)'s `Export filter settings as text file format`.
...
It is possible to import Equalizer presets from various sources including, <a href="https://wwmm.github.io/easyeffects/" target="_blank" rel="noopener noreferrer">EasyEffects</a> (as APO preset) and REW-compatible presets from <a href="https://housecurve.com/" target="_blank" rel="noopener noreferrer">HouseCurve</a>

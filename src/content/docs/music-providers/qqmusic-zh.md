...
该音乐源会以你的 QQ 音乐账号登录，你收藏的歌曲、专辑、关注的歌手与歌单会出现在 Music Assistant 中，整个曲库也可以直接搜索。
...
2. 点击 **QQ Login** 或 **WeChat Login**，会打开新的二维码页面。
3. 使用对应的 **QQ** 或 **微信** App 扫码，并在 App 内点击 **登录/确认**。
4. 关闭二维码页面。
5. 回到 Music Assistant 点击 **Save**。

> [!NOTE]
> 请使用与所选登录按钮匹配的 App 扫码。微信二维码需要用微信扫码，QQ 二维码需要用 QQ 扫码。

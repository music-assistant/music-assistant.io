...
A source an administrator adds is shared with everyone. Members can also add their own account for a service that can be added more than once, and only they can use it until they share it. See [Personal and shared music sources](/settings/user-management/#personal-and-shared-music-sources).

...
- <b>Take Over Stream.</b> Request that Pandora disconnect any other devices that are streaming and instead allow streaming via MA (See [Notes](#known-issues--notes) for more information)

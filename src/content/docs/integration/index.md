...
Note that there is also a [Home Assistant provider](/player-support/home-assistant/) within MA which functions the other way around. It enables Home Assistant functionality (and players) in Music Assistant!

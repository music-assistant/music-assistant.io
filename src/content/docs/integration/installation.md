...
The Home Assistant integration is the piece that makes your Music Assistant players appear in Home Assistant, ready to use from the dashboard, in automations and scripts, and by voice. The reverse direction, the Home Assistant plugin, works independently of the integration and can be added without it.

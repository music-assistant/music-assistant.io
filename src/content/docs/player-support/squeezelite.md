...
Music Assistant partly emulates a Logitech Media Server (which is now maintained as Lyrion Music Server, a.k.a. LMS) and has a full implementation of the Slim Protocol (also known as "SlimProto") in the form of player provider support for <a href="https://en.wikipedia.org/wiki/Squeezelite" target="_blank" rel="noopener noreferrer">Squeezelite</a> clients.
...
- Individual player [DSP settings](../settings/individual-player.md/#dsp-settings) will be used for [group](../faq/groups) playback

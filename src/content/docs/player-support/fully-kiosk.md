...
1. In Music Assistant, go to **Settings → Player Providers**, click **Add a player provider** and select `Fully Kiosk Browser` (Fully Kiosk players are not discovered automatically).

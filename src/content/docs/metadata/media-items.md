...
| Volume normalization value | File tags (`R128_*` and `REPLAYGAIN_*`, track and album), music providers (Plex, Subsonic, Tidal), otherwise measured by [Loudness Analysis](/audio-analysis/loudness-analysis) |

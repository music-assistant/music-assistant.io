...
Some plugins depend on something else being set up first. The [Home Assistant](/ha-plugin/) plugin needs a Home Assistant instance it can connect to, and [AI Radio](/plugins/ai-radio/) needs the Home Assistant plugin to reach an AI and text-to-speech service.

## All plugins

Every plugin, grouped by what it is for. Each one has its own page with the detail.

...
After successfully logging in, the first required action for the administrator is to add providers for [music sources](/music-providers/) and any necessary [players](/player-support/). This banner is shown to support this
